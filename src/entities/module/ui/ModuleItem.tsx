...
export const ModuleItem = observer(( { module, isHidePublicIcon, isHideBookmarkIcon }: IProps ) => {
    ...
    return (
        <>
            <div className='bg-white p-2 rounded-lg shadow-md hover:cursor-pointer flex gap-2 overflow-hidden w-full h-full group relative'>
                    ...
                    <div className='text-[10px] text-gray-300 absolute right-2 top-3'>
                        <div className={`text-blue-300 text-right ${module.options.isBookmarked ? 'text-blue-300' : 'text-gray-300'}`}><BookmarkIcon sx={{ width: 20, height: 20}}/></div>
                    </div>}
                    ...
                    <div className='overflow-hidden flex-auto flex flex-col'>
                        ...
                        <div className='font-semibold text-sm text-md text-slate-800 py-1 mb-2 flex-auto'>
